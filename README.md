...
**Persistent across sessions.** Everything saves as JSON. Close Claude, come back next week, `/itropa:status` shows exactly where you left off.
...
All research persists as JSON. Human-readable, git-friendly, yours to keep.
